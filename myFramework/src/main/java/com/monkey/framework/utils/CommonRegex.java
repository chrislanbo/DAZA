...
public class CommonRegex {
	...
	/** 中国的电话 */
	public static final String CN_PHONE = "^(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$";
	...
	public static final String PASSWORD = "(?!^[0-9]+$)(?!^[A-z]+$)(?!^[^A-z0-9]+$)^.{6,16}$"; // 6~16位 数字和字母组合（非纯数字或纯字母)
    /**
    ...
    public static boolean matchOnlyNumber(String str){
    	return matcherRegex(ONLY_NUMBER, str);
    }
    
    
    public static boolean matchPassword(String psd){
    	return matcherRegex(PASSWORD,psd);
    }
